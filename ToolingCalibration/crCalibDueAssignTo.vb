...
Public Class crCalibDueAssignTo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ToolingCalibration.crCalibDueAssignTo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCalibDueAssignTo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCalibDueAssignTo = New crCalibDueAssignTo()
        rpt.Site = Me.Site
        Return rpt
    End Function
